...
@adapters.register_for('postgres:pg8181')
class PostgrePG8181(Postgre):
    drivers = ('pg8181',)
    ...
    def execute(self, *args, **kwargs):
        ...
        return super(PostgrePG8181, self).execute(*args, **kwargs)
...
@adapters.register_for('postgres2:pg8181')
class PostgrePG8181New(PostgrePG8181, PostgreNew):
    pass
...
@adapters.register_for('postgres3:pg8181')
class PostgrePG8181Boolean(PostgrePG8181New, PostgreBoolean):
    pass
