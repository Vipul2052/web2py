...
def startwebserver():
    ...
    for a in range(1, 11):
        ...
        print(a, '...')
        try:
            c = WebClient('http://127.0.0.1:8181')
            c.get('/')
            break
        except:
            continue
...
class TestWeb(LiveTest):
    def testRegisterAndLogin(self):
        client = WebClient('http://127.0.0.1:8181/welcome/default/')
    ...
    def testSoap(self):
        ...
        url = 'http://127.0.0.1:8181/examples/soap_examples/call/soap?WSDL'
        ...
        s = WebClient('http://127.0.0.1:8181/')
        try:
