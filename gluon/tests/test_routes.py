...
'''
        load(data=data)
        self.assertEqual(filter_url('http://localhost:8181/service/person/create'), "/app/default/call ['json', 'create'] ?model=person")
        self.assertEqual(filter_url('http://localhost:8181/service/person/create?var1=val1'), "/app/default/call ['json', 'create'] ?model=person&var1=val1")
